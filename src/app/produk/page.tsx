    ...
    const packageList = [
      {
        ...
        price: 'Rp 9,999,000',
        items: ['1x Monitoring Drone', '1x Soil Sensor', 'AI Platform Access (3 Months)', '1x Online Training'],
      },
      {
        title: 'Professional Package',
        subtitle: 'For active farmers & cooperatives',
        price: 'Rp 19,999,000',
        items: ['1x Precision Drone', '3x IoT Sensors', 'AI Platform Access (6 Months)', 'Agronomist Consultation'],
      },
      {
        title: 'Corporate Package',
        subtitle: 'For large-scale & integrated farming',
        price: 'Rp 39,999,000',
        items: ['2x Precision Drones', '5x IoT Sensors', 'AI Platform Access (1 Year)', 'On-site Training'],
      },
    ];
      ...
      <div className="bg-white py-24" id="products-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600">Modern solutions for your agricultural and technology needs</p>
          </div>
